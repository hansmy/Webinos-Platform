 ...
 *
 * Copyright 2013 Richard Logan-Baker, AmbieSense
 ******************************************************************************/

(function() {
  App2App2Module = function (params) {

    if(typeof App2App2Module.prototype._singletonInstance !== 'undefined') {
      return App2App2Module.prototype._singletonInstance;
    }

    App2App2Module.prototype._singletonInstance = this;
  ...
  App2App2Module.prototype = new WebinosService();

  App2App2Module.prototype.bindService = function (bindCallback) {
    if (typeof bindCallback.onBind === 'function') {
      bindCallback.onBind(this);
    }
  };

  App2App2Module.prototype.unbindService = function (successCallback, errorCallback) {
    var params = {};
    ...
    webinos.rpcHandler.executeRPC(rpc,
      function (success) {
        App2App2Module.prototype._singletonInstance = undefined;
   ...
   * App2App2 Messaging API does not include a discovery mechanism for clients. A channel creator obtains the client
